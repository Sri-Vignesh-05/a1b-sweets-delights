    ...
    <div className="fixed top-0 left-0 right-0 bg-nav border-b border-border shadow-nav z-50">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-4">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="start" className="w-56 bg-card">
                <DropdownMenuItem>Andheri West Store</DropdownMenuItem>
                <DropdownMenuItem>Bandra East Store</DropdownMenuItem>
                <DropdownMenuItem>Juhu Beach Road</DropdownMenuItem>
                <DropdownMenuItem>Powai Central</DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
          </div>
          ...
          {/* Right: Customer Care, Login, Profile */}
